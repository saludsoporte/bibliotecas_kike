...
class EditorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create editorial" do
    assert_difference('Editorial.count') do
      post editorials_url, params: { editorial: { direccion: @editorial.direccion, nombre_edi: @editorial.nombre_edi, numero: @editorial.numero } }
    end
  ...
  test "should update editorial" do
    patch editorial_url(@editorial), params: { editorial: { direccion: @editorial.direccion, nombre_edi: @editorial.nombre_edi, numero: @editorial.numero } }
